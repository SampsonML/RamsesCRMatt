...
subroutine condinit(x,u,dx,nn)
  ...
  !u(1:nn,1) = 0.01 + (10.-0.01) * (1.+tanh( (x(1:nn,1)-200.)/25.) )  * (1. + tanh( (200.-x(1:nn,1))/25.)) 
  u(1:nn,1) = 0.1 + (10.-0.1) * (1.+tanh( (x(1:nn,1)-200.)/25.) )  * (1. + tanh( (200.-x(1:nn,1))/25.)) 
  !u(1:nn,1) = 0.1 + (1.-0.1) * (1.+tanh( (x(1:nn,1)-200.)/25.) )  * (1. + tanh( (200.-x(1:nn,1))/25.)) 
  u(1:nn,icrU) = 1d-6
  u(1:nn,icrU+1) = 0.0
