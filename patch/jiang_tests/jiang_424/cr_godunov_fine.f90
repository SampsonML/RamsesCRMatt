...
!------------------------------------------------------------------------
   ...
   ! Full step: uold->unew, using umid state
     ...
     do ind=1,twotondim
        ...
        do icr=1,ncr
           do idim=1,ndim
              ...
              if(pcrg(i,idim,icr).eq.3.) then
                  !print*,'fixing zero gradient'
                  gradpcr_loc(i,idim,icr)=0.
              endif
           enddo
           vs_loc(i,:)=0.
           va_loc(i)=0.
        ...
        do icr=1,ncr
            ...
            !print*,'sigma_x = ',sigma_x,bdotgradp_loc(i),va_loc(i),sigma_stream
