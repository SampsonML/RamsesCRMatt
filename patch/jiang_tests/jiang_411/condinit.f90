...
subroutine condinit(x,u,dx,nn)
  ...
  ! E_c = exp(-40*x**2)
  !u(1:nn,icru) = exp(-40.* ((x(1:nn,1)-boxlen*0.5)**2 + (x(1:nn,2)-boxlen*0.5)**2) )
  tmp(1:nn) = (x(1:nn,1)-boxlen*0.5)**2
  !tmp(1:nn) = (x(1:nn,2)-boxlen*0.5)**2
#if NDIM>1
