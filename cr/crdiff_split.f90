...
subroutine crdiff_split(uin,flux,dx,dt,ngrid,compute,fdx,igroup)
  ...
  real(dp),dimension(1:nvector,if1:if2,jf1:jf2,kf1:kf2)::Xflux
#if NDIM>1
  real(dp),dimension(1:nvector,if1:if2,jf1:jf2,kf1:kf2)::Yflux
#endif
#if NDIM>2
  real(dp),dimension(1:nvector,if1:if2,jf1:jf2,kf1:kf2)::Zflux
#endif
...
subroutine cmpXcrflx(Temp,Temp0,bf,myflux,dx,dt,ngrid,compute,ffdx,kpar,Dpara,kperp)
  ...
  real(dp)::fx,oneoverdx,oneovertwodx,oneoverfourdx
  real(dp)::dTdx1,dx_loc
  real(dp)::kpar,kpar2,oneminuskperp
#if NDIM>1
  real(dp)::Bnorm,bx1,bx2,by1,by2
  real(dp)::dTdx2,dTdy1,dTdy2
  real(dp)::fx1,fx2
  real(dp)::kparax1,kparax2
  real(dp)::kperpx1,kperpx2
  real(dp)::oneminuskperpx1,oneminuskperpx2
#endif
#if NDIM==3
  real(dp)::bx3,bx4,by3,by4
  real(dp)::bz1,bz2,bz3,bz4
  real(dp)::dTdx3,dTdx4,dTdy3,dTdy4
  real(dp)::dTdz1,dTdz2,dTdz3,dTdz4
  real(dp)::fx3,fx4
  real(dp)::kparax3,kparax4
  real(dp)::kperpx3,kperpx4
  real(dp)::oneminuskperpx3,oneminuskperpx4
#endif
  ...
  real(dp)::a0,b0,a,b
  real(dp)::c0,d0,c,d
  real(dp)::dTdy,dTdy0,dTdyMinus,dTdyMinus0 
  real(dp)::dTdyPlus0
  real(dp)::dTdyPlus
#endif
#if NDIM==3
  real(dp)::dTdz0,dTdzMinus0,dTdzPlus0
  real(dp)::dTdz,dTdzMinus,dTdzPlus
#endif
...
#if NDIM>1
  real(dp)::kparay1,kparay2,kperpy1,kperpy2
  real(dp)::oneminuskperpy1,oneminuskperpy2
  real(dp)::fy1,fy2
  real(dp)::bx1,bx2,by1,by2,bz1,bz2
  real(dp)::a0,b0,c0,d0,a,b,c,d
  real(dp)::dTdx1,dTdx2,dTdy2,dTdz1,dTdz2
  real(dp)::dTdx0,dTdxMinus0,dTdxPlus0,dTdz0,dTdzMinus0,dTdzPlus0
  real(dp)::dTdx,dTdxMinus,dTdxPlus,dTdz,dTdzMinus,dTdzPlus
#endif
#if NDIM>2
  real(dp)::kparay3,kparay4,kperpy3,kperpy4
  real(dp)::fy3,fy4
  real(dp)::bx3,bx4,by3,by4,bz3,bz4
  real(dp)::dTdx3,dTdx4,dTdy3,dTdy4,dTdz3,dTdz4
  real(dp)::oneminuskperpy3,oneminuskperpy4
#endif
...
subroutine cmpZcrflx(Temp,Temp0,bf,myflux,dx,dt,ngrid,compute,ffdx,kpar,Dpara,kperp)
  ...
  real(dp)::dTdz1,kpar,kpar2,dx_loc,oneoverdx,oneovertwodx,oneoverfourdx,oneminuskperp
#if NDIM==3
  real(dp)::Bnorm
  real(dp)::dTdx1,dTdx2,dTdx3,dTdx4
  real(dp)::dTdy1,dTdy2,dTdy3,dTdy4
  real(dp)::dTdz2,dTdz3,dTdz4
  real(dp)::bx1,bx2,bx3,bx4
  real(dp)::by1,by2,by3,by4
  real(dp)::bz1,bz2,bz3,bz4
  real(dp)::fz1,fz2,fz3,fz4
  real(dp)::kparaz1,kparaz2,kparaz3,kparaz4
