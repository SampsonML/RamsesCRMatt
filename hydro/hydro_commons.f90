module hydro_commons
  ...
  real(udp),target,allocatable,dimension(:,:)::uold,unew       ! State vector and its update
  ...
  real(dp),allocatable,dimension(:)  ::ediss_cr  ! Storing the accelerated CR energy source term
