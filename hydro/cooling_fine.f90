  ...
  do ind=1,twotondim
     ...
     if(rt_vc) then      ! Add/remove radiation work on gas. Eq A6 in RT15
        ...
        do i=1,nleaf
           ...
           uold(il,iegy) = uold(il,iegy) &    ! Add work to gas energy
                + work * group_egy(iIR) &
     ...
     if(.not. static) then
        ...
        do i=1,nleaf
           ...
           uold(ind_leaf(i),iegy) = uold(ind_leaf(i),iegy)           &
                                    - ekk(i) + ekk_new(i)
        end do
        do i=1,nleaf
           ekk(i)=ekk_new(i)
     ...
     if(isothermal)then
        do i=1,nleaf
           uold(ind_leaf(i),iegy) = T2min(i) + ekk(i) + err(i) + emag(i)
        end do
     else if(cooling .or. neq_chem)then
        do i=1,nleaf
           uold(ind_leaf(i),iegy) = T2(i) + T2min(i) + ekk(i) + err(i) + emag(i)
        end do
     endif
     ...
     if(cooling_cr)then
        do i=1,nleaf
           ...
           uold(ind_leaf(i),iegy) = T2(i) + T2min(i) + ekk(i) + emag(i) &
     ...
     if(rt_isIRtrap) then
        ...
        do i=1,nleaf
           ...
           uold(il,iegy)=uold(il,iegy)-uold(il,iIRtrapVar)+EIR_trapped
