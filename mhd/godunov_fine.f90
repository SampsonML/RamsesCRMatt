...
subroutine godfine1(ind_grid,ncache,ilevel)
  ...
  real(dp),dimension(1:nvector,0:twondim  ,1:nvar+3+ncrvars),save::u1=0.
  real(dp),dimension(1:nvector,1:twotondim,1:nvar+3+ncrvars),save::u2=0.
